...
# @@File             :  entrypoint.sh
# @@Description      :  entrypoint point for lenpaste
...
__heath_check() {
  ...
  start-lenpaste.sh healthcheck || status=$((status + 1))
...
export SSL_CERT_BOT DISPLAY CONFIG_DIR_INITIALIZED DATA_DIR_INITIALIZED SERVICE_USER
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
